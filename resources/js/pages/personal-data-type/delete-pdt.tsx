...
function DeletePdt({personalDataType}: {personalDataType: PersonalDataTypeInterface}) {
    ...
    const handelSubmit: FormEventHandler = (e) => {
        ...
        destroy(route('personal-data-type.destroy', personalDataType.id), {
            onSuccess: () => {
                reset();
                closeModal();
            },
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handelSubmit}>
                    <DialogHeader>
                        <DialogTitle>Delete Personal Data Type</DialogTitle>
