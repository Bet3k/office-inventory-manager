...
function DeletePdp({personalDataProcessed}: {personalDataProcessed: PersonalDataProcessedInterface}) {
    ...
    const {
        ...
        reset,
        clearErrors,
    } = useForm<Required<DeletePDPForm>>({
        password: '',
    });
    ...
    const handelSubmit: FormEventHandler = (e) => {
        ...
        destroy(route('personal-data-processed.destroy', personalDataProcessed.id), {
            onSuccess: () => {
                reset();
                closeModal();
            },
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handelSubmit}>
                    <DialogHeader>
                        <DialogTitle>Delete Personal Data Processed</DialogTitle>
